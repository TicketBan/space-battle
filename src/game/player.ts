...
export class Player {
  ...
  constructor(spriteSheet: SpriteSheet,private inputManager: InputManager, private gameWidth: number, private gameHeight: number) {
    const playerSprite = spriteSheet.sprites["playerShip1_blue"];
  ...
  public update(dt: number) {
    ...
    // y direction
    if (this.inputManager.isKeyDown("ArrowUWp")) {
